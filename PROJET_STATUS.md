...
| **F-05** | **Espace Administrateur** | 🔴 Non commencé | Gestion des rôles, statistiques globales et logs de sécurité |
...
### 1. Module de Rendez-vous (F-03)
- Gestion des calendriers consulaires et des plages horaires disponibles.
- Formulaire de prise de rendez-vous lié à une demande d'enrôlement active.

### 2. Espace Administrateur (F-05)
- Espace de visualisation et filtrage des logs d'audit pour les administrateurs.
- Gestion et assignation des rôles (Citoyen, Agent, Admin).

### 3. Module de Paiement (F-06)
